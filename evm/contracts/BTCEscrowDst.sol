...
/**
 * @title BTC Destination Escrow for Bitcoin→EVM atomic swaps
 * @notice Escrow contract for BTC→EVM swaps - holds ERC20/ETH, releases on secret reveal
 * @dev Used when Bitcoin is the source and EVM tokens are the destination

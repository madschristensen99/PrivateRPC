...
/**
 * @title BTC Source Escrow for EVM→Bitcoin atomic swaps
 * @notice Escrow contract for EVM→BTC swaps - holds ERC20/ETH, releases when taker provides secret
 * @dev Used when EVM tokens are the source and Bitcoin is the destination

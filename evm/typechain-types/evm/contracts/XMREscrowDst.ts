...
export interface XMREscrowDstInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FACTORY"
      | "PROXY_BYTECODE_HASH"
...
export interface XMREscrowDst extends BaseContract {
  connect(runner?: ContractRunner | null): XMREscrowDst;
  waitForDeployment(): Promise<this>;

  interface: XMREscrowDstInterface;
  ...
  setSwapReady: TypedContractMethod<
    [hashlock: BytesLike, immutables: IBaseEscrow.ImmutablesStruct],
    [void],
    "nonpayable"
  >;
